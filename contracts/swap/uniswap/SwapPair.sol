...
import "./interface/ISwapCallee.sol";
import "../../token/ERC20/extensions/Permit.sol";
import "../../utils/math/Math.sol";
import "../../utils/math/SafeMath.sol";
import "../../utils/math/UQ112x112.sol";

abstract contract SwapPair is ISwapPair, Permit {
    using SafeMath for uint256;
    using UQ112x112 for uint224;

    uint256 public constant override MINIMUM_LIQUIDITY = 10**3;
    uint8 public override swapFee = 3;
    ...
    constructor(string memory _name, string memory _symbol)
        ERC20(_name, _symbol, 0, address(0))
        Permit(_name)
    {
        factory = msg.sender;
    }
